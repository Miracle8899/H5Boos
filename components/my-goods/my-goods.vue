<template>
	<view class="my-goods">
		<view class="my-goods-box" v-for="(item, index) in list" :key="index" @click="onClick(item)">
			<view class="title" >
				...
				<!-- <image src="../../static/images/3.png" v-if="index === 3"></image> -->
				<!-- 2<image src="../../static/images/3.png" v-if="index === 4"></image> -->
			...
			<view class="detail">
				...
				<view class="left,box">
					<text class="amount">销售额(元):</text>
					<text class="left-word">  {{item.total}}</text>
				</view>
			</view>
		</view>
	</view>
